...
export default function ContactsScreen() {
    const contacts = [
        ...
        {name:"Jared Mensah", number:"011-234-6534"},
        {name:"Mom", number:"035-654-9876"},
        {name:"Daddy", number:"233-654-5878"},
        {name:"sam Bob", number:"043-786-7651"},
        {name:"Daniel Mensah", number:"231-563-2388"},
        {name:"Susana Mensah", number:"543-712-6758"},
        {name:"Jared Mensah", number:"021-234-6534"},
        {name:"Mom", number:"045-654-9876"},
        {name:"Daddy", number:"233-754-5878"},
